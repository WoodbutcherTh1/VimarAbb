        ...
        <div className="flex items-center gap-2">
          {SHOWROOM_CONTACT.phone && (
            <a
              ...
              className="hidden items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-muted transition-colors hover:text-navy-900 lg:flex"
            >
          ...
          <button
            ...
            className="relative flex h-10 items-center gap-2 rounded-lg border border-line bg-white px-3.5 text-sm font-semibold text-navy-900 shadow-sm transition-colors hover:border-slate-300 hover:bg-slate-50"
          >
          ...
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-lg border border-line bg-white text-navy-900 md:hidden"
          >
